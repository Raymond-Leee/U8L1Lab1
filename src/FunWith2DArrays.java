public class FunWith2DArrays
{
    ...
    public static void fourCorners(String[][] strArray)
    {
        ...
        int column = strArray[0].length;

        System.out.println(strArray[0][0]);
        System.out.println(strArray[0][column - 1]);
        System.out.println(strArray[row - 1][0]);
        System.out.println(strArray[row - 1][ column - 1]);
    }
}